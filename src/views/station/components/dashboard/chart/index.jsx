...
import { getDeviceView } from '../../../../../api/station'
...
export default class Chart extends Component {
  ...
  getChart = () => {
    const { type, date, stationId } = this.state
    getDeviceView({type, date, stationId}).then(res => {
      // console.log(res)
  ...
  render() {
    ...
    return (
      <Card style={{ margin: '20px 0' }}>
        <div style={{ fontSize: 16 }}>电站历史数据</div>
        <div style={{ textAlign: 'right' }}>
          <Radio.Group value={type} onChange={this.btnChange} size='small' style={{ marginRight: 10 }}>
        ...
        <div id="c1" style={{width: '100%', height: 280, overflow: 'hidden' }}></div>
      </Card>
    )
  }
}
